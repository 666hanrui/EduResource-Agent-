...
export async function generateClassroom(
  ...
  const requirement = input.eduResourceContext
    ? buildEduResourceRequirement({
        baseRequirement: input.requirement,
  ...
  const stage: Stage = {
    ...
    createdAt: Date.now(),
    updatedAt: Date.now(),
    ...(input.eduResourceContext ? { eduResourceContext: input.eduResourceContext } : {}),
