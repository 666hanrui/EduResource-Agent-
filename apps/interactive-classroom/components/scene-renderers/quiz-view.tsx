...
import { submitEduResourceQuizAttemptWriteback } from '@/lib/eduresource/quiz-attempts';
...
export function QuizView({ questions, sceneId }: QuizViewProps) {
  ...
  const handleSubmit = useCallback(() => {
    ...
    void submitEduResourceQuizAttemptWriteback({
      stage,
      sceneId,
      answers,
      onError: (error) => {
        log.error('[quiz-view] EduResource quiz attempt writeback failed', error);
      },
    });
  }, [clearAnswersCache, answers, sceneId, stage]);
