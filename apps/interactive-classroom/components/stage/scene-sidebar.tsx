  ...
  return (
    ...
    >
      ...
      <div className={cn('flex flex-col w-full h-full overflow-hidden', collapsed && 'hidden')}>
        ...
        <div className="mx-3 mb-3 rounded-lg border border-gray-200/80 dark:border-gray-700/80 bg-white/70 dark:bg-slate-950/40 px-3 py-2 text-[10px] leading-4 text-gray-500 dark:text-gray-400">
          <div className="font-semibold text-gray-700 dark:text-gray-200">OpenMAIC AGPL-3.0 derivative</div>
          <div className="mt-1 flex flex-wrap gap-x-2 gap-y-1">
            <a
              href="/OPENMAIC-AGPL-NOTICE.md"
              target="_blank"
              rel="noreferrer"
              className="underline underline-offset-2 hover:text-purple-600 dark:hover:text-purple-300"
            >
              License notice
            </a>
            <a
